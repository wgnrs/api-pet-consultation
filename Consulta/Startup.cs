    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AppDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("MeuDbContextDB")));
            ...
            services.AddScoped<ConsultaPetRepository>();

            services.AddScoped<PessoaService>();
            services.AddScoped<AnimalService>();
            services.AddScoped<ConsultaPetService>();
            services.AddScoped<ConsultaApplicationService>();
        }
